...
from image_utils.layout_detect import detect_layout
from image_utils.layout_sorter import LayoutSorter
...
if __name__ == "__main__":
    ...
    # 添加可视化
    from image_utils.layout_visualizer import LayoutVisualizer
